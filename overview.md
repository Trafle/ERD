...
- [**Класифікація тексту**](https://monkeylearn.com/what-is-text-classification/) (також Тегування тексту, або категорізація) - процес класифікації тексту в організовані групи. Використовуючи [NLP](#my-multi-word-header)
...
- [**NLP**](https://en.wikipedia.org/wiki/Natural_language_processing) (англ. Natural Language Processing) - 
...
## [Аналізування й визначення змісту документа як об’єкта індексування](https://bit.ly/2SKLs8P)
